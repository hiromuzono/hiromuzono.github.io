                ...
                <div key={parentName} className="bg-white border border-gray-200 p-5">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <input type="number" value={limits[parentName] ?? "40"} onChange={e => setLimits(prev => ({ ...prev, [parentName]: e.target.value }))} min={1} className="flex-1 border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#1a1f3a]" />
                      <button onClick={() => handleLimit(parentName)} disabled={limitLoading === parentName} className="bg-[#1a1f3a] hover:bg-[#252b4a] disabled:opacity-40 text-white font-semibold px-5 py-3 text-sm transition-colors">{limitLoading === parentName ? "更新中..." : "更新"}</button>
                    </div>
          ...
          <div className="bg-white shadow-2xl p-5 w-full max-w-md">
            ...
            {actionState.type === "negotiate" && (
              <div className="mb-4">
                ...
                <input type="number" value={actionState.ticketsNegotiated} onChange={e => setActionState({ ...actionState, ticketsNegotiated: e.target.value })} placeholder="提案枚数" min={0.5} step={0.5} className="w-full border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#1a1f3a]" />
              </div>
            )}
            <div className="mb-4">
              ...
              <textarea value={actionState.childComment} onChange={e => setActionState({ ...actionState, childComment: e.target.value })} rows={3} className="w-full border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#1a1f3a] resize-none" />
            </div>
            <div className="flex gap-3">
